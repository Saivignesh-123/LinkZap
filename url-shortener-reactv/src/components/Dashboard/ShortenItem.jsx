...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    const fetchMyShortUrl = async () => {
        setLoader(true);
        try {
            // 🔥 Dynamic dates: from creation date to today
            ...
            // 🔥 Map backend object to array for Graph
            const transformed = Object.values(
                data.reduce((acc, item) => {
                    const date = item.clickDate; // already YYYY-MM-DD from backend
